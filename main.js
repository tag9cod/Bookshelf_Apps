...
const formBook = document.getElementById("inputBuku");
...
formBook.addEventListener("submit", function (event) {
  	...
  	const author = document.getElementById("pen").value;
  	const year = parseInt(document.getElementById("thn").value);
  	const isComplete = document.getElementById("baca").checked;

  	const idTemp = document.getElementById("jdl").name;
  		if (idTemp !== "") {
...
function RenderBookList(bookData) {
  	...
  	const containerIncomplete = document.getElementById("belum");
  	const containerComplete = document.getElementById("sudah");
...
function UpdateAnItem(itemElement) {
  	if (itemElement.id === "belum" || itemElement.id === "sudah") {
    	return;
  	}
  	...
  	document.getElementById("jdl").value = title;
  	document.getElementById("jdl").name = id;
  	document.getElementById("pen").value = author;
  	document.getElementById("thn").value = year;
  	document.getElementById("baca").checked = isComplete;
...
function ResetAllForm() {
  	...
  	document.getElementById("baca").checked = false;
